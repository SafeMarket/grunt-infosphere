contract infosphered is owned{
    ...
    function setBytes1ByForce(bytes32 key, bytes1 value) internal{
        infosphere.setBytes1(key,value);
    }

    function getBytes1(bytes32 key) constant returns(bytes1){
    ...
    function setBytes5ByForce(bytes32 key, bytes5 value) internal{
        infosphere.setBytes5(key,value);
    }

    function getBytes5(bytes32 key) constant returns(bytes5){
    ...
    function setBytes9ByForce(bytes32 key, bytes9 value) internal{
        infosphere.setBytes9(key,value);
    }

    function getBytes9(bytes32 key) constant returns(bytes9){
    ...
    function setBytes13ByForce(bytes32 key, bytes13 value) internal{
        infosphere.setBytes13(key,value);
    }

    function getBytes13(bytes32 key) constant returns(bytes13){
    ...
    function setBytes17ByForce(bytes32 key, bytes17 value) internal{
        infosphere.setBytes17(key,value);
    }

    function getBytes17(bytes32 key) constant returns(bytes17){
    ...
    function setBytes21ByForce(bytes32 key, bytes21 value) internal{
        infosphere.setBytes21(key,value);
    }

    function getBytes21(bytes32 key) constant returns(bytes21){
    ...
    function setBytes25ByForce(bytes32 key, bytes25 value) internal{
        infosphere.setBytes25(key,value);
    }

    function getBytes25(bytes32 key) constant returns(bytes25){
    ...
    function setBytes29ByForce(bytes32 key, bytes29 value) internal{
        infosphere.setBytes29(key,value);
    }

    function getBytes29(bytes32 key) constant returns(bytes29){
    ...
    function setUint8ByForce(bytes32 key, uint8 value) internal{
        infosphere.setUint8(key,value);
    }

    function getUint8(bytes32 key) constant returns(uint8){
    ...
    function setUint32ByForce(bytes32 key, uint32 value) internal{
        infosphere.setUint32(key,value);
    }

    function getUint32(bytes32 key) constant returns(uint32){
    ...
    function setUint56ByForce(bytes32 key, uint56 value) internal{
        infosphere.setUint56(key,value);
    }

    function getUint56(bytes32 key) constant returns(uint56){
    ...
    function setUint80ByForce(bytes32 key, uint80 value) internal{
        infosphere.setUint80(key,value);
    }

    function getUint80(bytes32 key) constant returns(uint80){
    ...
    function setUint104ByForce(bytes32 key, uint104 value) internal{
        infosphere.setUint104(key,value);
    }

    function getUint104(bytes32 key) constant returns(uint104){
    ...
    function setUint128ByForce(bytes32 key, uint128 value) internal{
        infosphere.setUint128(key,value);
    }

    function getUint128(bytes32 key) constant returns(uint128){
    ...
    function setUint152ByForce(bytes32 key, uint152 value) internal{
        infosphere.setUint152(key,value);
    }

    function getUint152(bytes32 key) constant returns(uint152){
    ...
    function setUint176ByForce(bytes32 key, uint176 value) internal{
        infosphere.setUint176(key,value);
    }

    function getUint176(bytes32 key) constant returns(uint176){
    ...
    function setUint200ByForce(bytes32 key, uint200 value) internal{
        infosphere.setUint200(key,value);
    }

    function getUint200(bytes32 key) constant returns(uint200){
    ...
    function setUint224ByForce(bytes32 key, uint224 value) internal{
        infosphere.setUint224(key,value);
    }

    function getUint224(bytes32 key) constant returns(uint224){
    ...
    function setUint248ByForce(bytes32 key, uint248 value) internal{
        infosphere.setUint248(key,value);
    }

    function getUint248(bytes32 key) constant returns(uint248){
    ...
    function setInt8ByForce(bytes32 key, int8 value) internal{
        infosphere.setInt8(key,value);
    }

    function getInt8(bytes32 key) constant returns(int8){
    ...
    function setInt72ByForce(bytes32 key, int72 value) internal{
        infosphere.setInt72(key,value);
    }

    function getInt72(bytes32 key) constant returns(int72){
    ...
    function setInt136ByForce(bytes32 key, int136 value) internal{
        infosphere.setInt136(key,value);
    }

    function getInt136(bytes32 key) constant returns(int136){
    ...
    function setInt200ByForce(bytes32 key, int200 value) internal{
        infosphere.setInt200(key,value);
    }

    function getInt200(bytes32 key) constant returns(int200){
